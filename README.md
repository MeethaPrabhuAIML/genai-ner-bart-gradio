...
text = "My name is Meetha, I'm building DeepLearningAI and I live in Chennai"
...
demo = gr.Interface(fn=ner,
                    ...
                    description="Find entities using the `dslim/bert-base-NER` model under the hood!",
                    allow_flagging="never",
                    examples=["My name is Meetha, I'm building DeeplearningAI and I live in Chennai", "My name is Vijay, I live in Chennai and work at TCS"])
